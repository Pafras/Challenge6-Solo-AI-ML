...
- [x] **Model audio** — ulang A2b vs A3 pakai 3 seed, laporin rata-rata ± simpangan. Selisih mereka 2–3 poin, masih dalam goyangan → pilih model final dari sini
...
- [x] Draft dua model card selagi angkanya masih anget
...
- [x] Genre: Techno / EDM / Breakbeat / Bounce / Brazil funk, dipilih pengguna (bukan model), grid 1/16, takaran volume per genre
