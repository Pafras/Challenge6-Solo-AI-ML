...
**Cacat di A2: normalisasinya salah.** MEAN/STD (-32,0 / 22,7) diukur waktu padding nol, dan blok padding nol itu jatuh ke lantai -80 dB. Dengan padding noise, statistik train jadi **-19,2 / 14,5**, jadi input A2 masuk dengan rata-rata ≈ +0,56 dan std ≈ 0,64, bukan 0 / 1. BatchNorm setelah conv pertama nyerap geseran semacam ini, jadi +7 poinnya kemungkinan tetap nyata, tapi belum bersih. Mulai sekarang statistik dikunci per kombinasi padding/normalisasi, dan A2 diulang (A2b) sebelum dibandingin sama A3.
